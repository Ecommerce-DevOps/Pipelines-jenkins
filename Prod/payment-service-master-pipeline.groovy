    ...
    stages {
        ...
        stage('Checkout SCM') {
            steps {
                ...
                // Checkout Payment Service repo (Required for Release Notes & Tagging)
                dir('payment-service') {
                    git branch: 'main', url: 'https://github.com/Ecommerce-DevOps/payment-service.git', credentialsId: 'github-credentials'
                }
                        ...
                        withCredentials([usernamePassword(credentialsId: 'github-credentials', usernameVariable: 'GIT_USERNAME', passwordVariable: 'GIT_PASSWORD')]) {
                            sh """
                                ...
                                if git rev-parse ${releaseTag} >/dev/null 2>&1; then
                                    ...
                                    git push https://\${GIT_USERNAME}:\${GIT_PASSWORD}@github.com/Ecommerce-DevOps/payment-service.git ${releaseTag} || echo "⚠️ Tag ya existe en remoto o error al pushear"
                                fi
                            """
                        }
