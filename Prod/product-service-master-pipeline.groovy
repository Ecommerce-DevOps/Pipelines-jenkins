    ...
    stages {
        ...
        stage('Checkout SCM') {
            steps {
                ...
                // Checkout Product Service repo (Required for Release Notes & Tagging)
                dir('product-service') {
                    git branch: 'main', url: 'https://github.com/Ecommerce-DevOps/product-service.git', credentialsId: 'github-credentials'
                }
                        ...
                        withCredentials([usernamePassword(credentialsId: 'github-credentials', usernameVariable: 'GIT_USER', passwordVariable: 'GIT_PASS')]) {
                            sh """
                                ...
                                if git rev-parse ${releaseTag} >/dev/null 2>&1; then
                                    ...
                                    git push https://\${GIT_USER}:\${GIT_PASS}@github.com/Ecommerce-DevOps/product-service.git ${releaseTag} || echo "⚠️ Error al pushear tag"
                                fi
                            """
                        }
