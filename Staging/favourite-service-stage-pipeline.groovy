                    ...
                    sh """
                        ...
                        for i in {1..30}; do
                            if kubectl run eureka-check-${BUILD_NUMBER} --image=curlimages/curl:latest \
                                ...
                                curl -s -f http://discovery:8761/eureka/apps/FAVOURITE-SERVICE | grep -q "UP"; then
                                echo "✅ FAVOURITE-SERVICE registrado y UP en Eureka"
                                break
                            fi
                            
                            echo "⏳ Esperando a que FAVOURITE-SERVICE se registre en Eureka... (\$i/30)"
